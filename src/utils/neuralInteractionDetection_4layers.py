...
DATASET_NAME = "purely_epistatic_risk_model_MAF005_her005_EDM-1_1"
if __name__ == "__main__":
    ...
    layerWeights0 = np.load(
        '..\\data\\weights\\layer_0_weights_' + DATASET_NAME + '_numLayers4.npy', allow_pickle=True)
    layerWeights1 = np.load(
        '..\\data\\weights\\layer_1_weights_' + DATASET_NAME + '_numLayers4.npy', allow_pickle=True)
    layerWeights2 = np.load(
        '..\\data\\weights\\layer_2_weights_' + DATASET_NAME + '_numLayers4.npy', allow_pickle=True)
    layerWeights3 = np.load(
        '..\\data\\weights\\layer_3_weights_' + DATASET_NAME + '_numLayers4.npy', allow_pickle=True)
    layerWeights4 = np.load(
        '..\\data\\weights\\layer_4_weights_' + DATASET_NAME + '_numLayers4.npy', allow_pickle=True)
    layerWeights5 = np.load(
        '..\\data\\weights\\layer_5_weights_' + DATASET_NAME + '_numLayers4.npy', allow_pickle=True)
    ...
    aggregateWeightsD1 = np.matmul(np.array(outputWeights), np.array(dense4Weights))
    aggregateWeightsD1 = np.matmul(aggregateWeightsD1, np.array(dense3Weights))
    aggregateWeightsD1 = np.matmul(aggregateWeightsD1, np.array(dense2Weights))
