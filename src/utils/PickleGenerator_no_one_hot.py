...
DATASET_DIR_PATH = "../data/largeFiles/datasets/synthetic/purely_epistatic/purely_epistatic_risk_model_MAF05_her005_EDM-1-1/"
        ...
        for row in tqdm(csv_reader):
            ...
            for snp in row[0:-1]:
                if snp == "0":
                    ...
                    genotype += [-1] #just for robustness, there are no missing data in synthatic datasets.
...
if __name__ == "__main__":
    ...
    for d in tqdm(dataFiles):
        ...
        pPath = PICKLE_DIR_PATH + d[0:-4] + "_no_one_hot.p"
