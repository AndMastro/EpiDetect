...
if __name__ == "__main__":
    ...
    meRank = sorted(((v, k) for k, v in marginal_effects.items()), reverse=False) #biased toward high marginal effect with negative effect. Makes sense tbh, very strong negative ME.
    marginal_effects = {}
    for elem in meRank:
