...
DATASET_NAME = "epistatic_risk_model_MAF01_eta01_theta05_EDM-1_10" #1 is MAF=0.2 and 2 is MAF=0.5 ---- it should make sense now. Prevalence should reflect #controls. Am I right?
