...
DATASET_NAME = "additive_risk_model_MAF01_eta01_theta0.5_EDM-1_10" #1 is MAF=0.2 and 2 is MAF=0.5 ---- it should make sense now. Prevalence should reflect #controls. Am I right?
